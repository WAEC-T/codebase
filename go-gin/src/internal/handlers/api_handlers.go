...
// 		followers, err := db.GetFollowing(userIdStr, numFollrInt)
// 		if err != nil {
...
// 			// Follow the user
// 			if err := db.FollowUser(userIdStr, profileUserIDStr); err != nil {
...
// 			// Unfollow the user
// 			if err := db.UnfollowUser(userIdStr, profileUserIDStr); err != nil {
